...
void jp_n16(uint8_t *instruction, uint8_t *cpu_cycles, uint8_t *number_of_bytes);
void jp_NZ_n16(uint8_t *instruction, uint8_t *cpu_cycles, uint8_t *number_of_bytes);
void jp_Z_n16(uint8_t *instruction, uint8_t *cpu_cycles, uint8_t *number_of_bytes);
void jp_NC_n16(uint8_t *instruction, uint8_t *cpu_cycles, uint8_t *number_of_bytes);
void jp_C_n16(uint8_t *instruction, uint8_t *cpu_cycles, uint8_t *number_of_bytes);

void jr_n16(uint8_t *instruction, uint8_t *cpu_cycles, uint8_t *number_of_bytes);
void jr_NZ_n16(uint8_t *instruction, uint8_t *cpu_cycles, uint8_t *number_of_bytes);
void jr_Z_n16(uint8_t *instruction, uint8_t *cpu_cycles, uint8_t *number_of_bytes);
void jr_NC_n16(uint8_t *instruction, uint8_t *cpu_cycles, uint8_t *number_of_bytes);
void jr_C_n16(uint8_t *instruction, uint8_t *cpu_cycles, uint8_t *number_of_bytes);
